...
This folder contains operational and task-specific reference material.
...
- iOS package or capability setup

These docs are useful, but they are not the same as the canonical project docs.
